...
**2** *Change* the **install** script file executable on the Linux box:        chmod +x ./install

**3** *Run* the **install** script file, use the "help" directive to get help:          ./install help
