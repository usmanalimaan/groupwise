...
echo ""
echo -e "\e[41m$0 -Uvdns\033[0;93m\033[0;92m"
# echo "$0 -Uvdns"
echo ""
echo "-------------------"
fi
...
{
sudo cimitra get import & 1> /dev/null 2> /dev/null &
} 1> /dev/null 2> /dev/null 

{
sudo cimitra get server & 1> /dev/null 2> /dev/null &
} 1> /dev/null 2> /dev/null 
